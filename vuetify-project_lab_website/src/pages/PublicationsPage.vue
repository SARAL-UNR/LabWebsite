...
// Color-code venue chips by publication type
function venueColor(type) {
  if (type === 'journal') return 'blue'
  if (type === 'workshop') return 'orange'
  return 'error' // conference → red (matches brand)
}
</script>
